...
# 화면 타이틀 설정
pygame.display.set_caption("컨트롤 테슽흐")
...
current_path = os.path.dirname(__file__)#현재 파일의 속도 위치 반환
...
# 공 크기에 따른 최초 스피드
ball_speed_y = [-18, -15, -12, -9] # index 0, 1, 2, 3에 ㅐ해당하는 값
...
while running:
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        # 가로벽에 닿았을 때 공 위치 이동 위치 변경 (튕겨 나오는 효과)
